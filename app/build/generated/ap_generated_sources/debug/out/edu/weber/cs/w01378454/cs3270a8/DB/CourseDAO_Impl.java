  ...
  public CourseDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCourse = new EntityInsertionAdapter<Course>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `Course` (`_id`,`id`,`course_name`,`course_code`,`start_at`,`end_at`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Course value) {
        ...
        if (value.getCourse_name() == null) {
          ...
          stmt.bindString(3, value.getCourse_name());
        }
        if (value.getCourse_code() == null) {
          stmt.bindNull(4);
        } else {
          stmt.bindString(4, value.getCourse_code());
        }
        if (value.getStart_at() == null) {
          stmt.bindNull(5);
        } else {
          stmt.bindString(5, value.getStart_at());
        }
        if (value.getEnd_at() == null) {
          stmt.bindNull(6);
        } else {
          stmt.bindString(6, value.getEnd_at());
        }
      }
    };
    ...
    this.__updateAdapterOfCourse = new EntityDeletionOrUpdateAdapter<Course>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `Course` SET `_id` = ?,`id` = ?,`course_name` = ?,`course_code` = ?,`start_at` = ?,`end_at` = ? WHERE `_id` = ?";
      }
      ...
      public List<Course> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Course(_tmp_id,_tmpId,_tmpCourse_name,_tmpCourse_code,_tmpStart_at,_tmpEnd_at);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Course getCourseByID(final String id) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        final String _tmpEnd_at;
        _tmpEnd_at = _cursor.getString(_cursorIndexOfEndAt);
        _result = new Course(_tmp_id,_tmpId,_tmpCourse_name,_tmpCourse_code,_tmpStart_at,_tmpEnd_at);
      } else {
        _result = null;
      }
      return _result;
